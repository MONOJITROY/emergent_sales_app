...
<div class="modal fade" id="purchaseModal" tabindex="-1"><div class="modal-dialog modal-dialog-centered modal-xl"><div class="modal-content">
  ...
  <div class="modal-body">
    <div class="row g-3 mb-3">
      <div class="col-md-6"><label class="form-label small text-uppercase fw-semibold">Supplier</label><select id="supplierSel" class="form-select form-select-sm"><option value="">— pick a supplier —</option></select></div>
      <div class="col-md-6"><label class="form-label small text-uppercase fw-semibold">Supplier name *</label><input id="supplierName" class="form-control form-control-sm"></div>
    </div>
    <div class="border rounded"><div class="d-flex justify-content-between align-items-center bg-light px-2 py-2 border-bottom">
    ...
    <div class="table-responsive"><table class="table table-sm sf-table mb-0">
      <thead><tr><th style="width:40%">Product</th><th class="text-end">Qty</th><th class="text-end">Cost</th><th class="text-end">Total</th><th></th></tr></thead>
      <tbody id="lines"><tr><td colspan="5" class="text-center text-muted small py-2">No items.</td></tr></tbody>
    </table></div></div>
    <div class="row g-3 mt-3">
      ...
      <div class="col-md-6">
        ...
        <div class="d-flex justify-content-between align-items-center mt-2"><span>Tax</span><input id="pTax" type="number" step="any" class="form-control form-control-sm text-end" style="width:120px" value="0"></div>
