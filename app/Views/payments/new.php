...
<div class="d-flex justify-content-between align-items-center mb-3 no-print">
  <a href="<?= View::e($_baseUrl) ?>/payments" class="small text-muted text-decoration-none"><i class="bi bi-arrow-left"></i> Back</a>
  <h5 class="mb-0 fw-bold">New Payment</h5>
  <div></div>
</div>
...
<div class="row g-3">
  <div class="col-lg-8">
    <div class="card sf-card"><div class="card-body">
      <div class="text-uppercase small fw-semibold text-secondary mb-2" style="font-size:.7rem;letter-spacing:.06em">Supplier</div>
      <div class="row g-2 mb-3">
        <div class="col-md-6">
          <select id="supplierSelect" class="form-select form-select-sm" data-testid="supplier-select">
            <option value="">— Select Supplier —</option>
          </select>
        </div>
        <div class="col-md-6">
          <!-- <div class="text-uppercase small fw-semibold text-secondary mb-0" style="font-size:.7rem;letter-spacing:.06em">Payment Type</div> -->
          <div class="d-flex gap-3 mb-3 mt-2">
            <div class="form-check">
              <input class="form-check-input" type="radio" name="paymentType" id="typePartial" value="partial" checked>
              <label class="form-check-label" for="typePartial">Partial Payment</label>
            </div>
            <div class="form-check">
              <input class="form-check-input" type="radio" name="paymentType" id="typeLumpsum" value="lumpsum">
              <label class="form-check-label" for="typeLumpsum">Lumpsum Payment</label>
            </div>
          </div>
        </div>
      </div>

<!--       <div class="text-uppercase small fw-semibold text-secondary mb-2" style="font-size:.7rem;letter-spacing:.06em">Payment Type</div>
      ...
      <!-- Lumpsum Payment Section -->
      <div id="lumpsumSection" style="display:none">
        <div class="row g-2 mb-3">
          <div class="col-md-3">
            <label class="form-label small">Total Payment Amount</label>
        ...
        <div class="table-responsive"><table class="table table-sm sf-table">
          ...
          <tbody id="allocRows"><tr><td colspan="7" class="text-center text-muted py-3">Select supplier and enter amount</td></tr></tbody>
        </table></div>
      </div>
    </div></div>
  </div>
  ...
  <div class="col-lg-4">
    <div class="card sf-card"><div class="card-body">
      ...
      <div class="d-flex justify-content-between align-items-center mb-2">
        <span class="small text-muted">Total to Pay</span>
        <span class="text-num fw-bold text-orange" id="totalPayDisplay">0.00</span>
      </div>

      <button class="btn sf-btn-primary w-100" id="submitPayment" disabled data-testid="submit-payment">
...
<?php $GLOBALS['pageScript'] = '<script>SF.paymentNew();</script>'; ?>
