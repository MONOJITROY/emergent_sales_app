...
<h1 class="h3 fw-bold mb-1 mt-2">New Sale</h1>
<p class="text-muted small mb-3">Create an invoice and decrement stock.</p>
...
<div class="card sf-card mb-3">
  ...
  <div class="table-responsive"><table class="table table-sm sf-table mb-0">
    ...
    <tbody id="lines"><tr><td colspan="5" class="text-center text-muted py-3 small">No items yet.</td></tr></tbody>
  </table></div>
</div>
...
<div class="row g-3 mb-3">
  ...
  <div class="col-md-6"><div class="card sf-card h-100"><div class="card-body">
    ...
    <div class="d-flex justify-content-between align-items-center mt-2"><span>Discount</span><input id="discount" type="number" step="any" class="form-control form-control-sm text-end" style="width:120px" value="0"></div>
    <div class="d-flex justify-content-between align-items-center mt-2"><span>Tax</span><input id="tax" type="number" step="any" class="form-control form-control-sm text-end" style="width:120px" value="0"></div>
    <hr class="my-2">
    <div class="d-flex justify-content-between"><strong>Total</strong><strong class="text-num h5 mb-0" id="total">0.00</strong></div>
    <div class="d-flex justify-content-between align-items-center mt-2"><span>Paid now</span><input id="paid" type="number" step="any" class="form-control form-control-sm text-end" style="width:120px" value="0"></div>
